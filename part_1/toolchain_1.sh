...
bash .gcc_2.sh gcc-9.2.0.tar.xz gcc-9.2.0
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .tcl8.sh tcl8.6.10-src.tar.gz tcl8.6.10-src
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .expect5.sh expect5.45.4.tar.gz expect5.45.4
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .dejagnu.sh dejagnu-1.6.2.tar.gz dejagnu-1.6.2 
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .m4.sh m4-1.4.18.tar.xz m4-1.4.18
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .ncurses.sh ncurses-6.2.tar.gz ncurses-6.2
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .bash.sh bash-5.0.tar.gz bash-5.0
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .bison.sh bison-3.5.2.tar.xz bison-3.5.2
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .bzip2.sh bzip2-1.0.8.tar.gz bzip2-1.0.8
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .coreutils.sh coreutils-8.31.tar.xz coreutils-8.31
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .diffutils.sh diffutils-3.7.tar.xz diffutils-3.7
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .file.sh file-5.38.tar.gz file-5.38
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .findutils.sh findutils-4.7.0.tar.xz findutils-4.7.0
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .gawk.sh gawk-5.0.1.tar.xz gawk-5.0.1
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .gettext.sh gettext-0.20.1.tar.xz gettext-0.20.1
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .grep.sh grep-3.4.tar.xz grep-3.4
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .gzip.sh gzip-1.10.tar.xz gzip-1.10
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .make.sh make-4.3.tar.gz make-4.3
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .patch.sh patch-2.7.6.tar.xz patch-2.7.6
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .perl.sh perl-5.30.1.tar.xz perl-5.30.1
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .Python.sh Python-3.8.1.tar.xz Python-3.8.1
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .sed.sh sed-4.8.tar.xz sed-4.8
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .tar.sh tar-1.32.tar.xz tar-1.32
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .texinfo.sh texinfo-6.7.tar.xz texinfo-6.7
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
...
bash .xz.sh xz-5.2.4.tar.xz xz-5.2.4
status=$?
if [ $status -eq 0 ]; then	
	printf "\033[32m ✓✓✓\033[0m\n"
else
